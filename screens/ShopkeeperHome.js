...
import { Button, Dimensions, Image, RefreshControl, ScrollView, StyleSheet, Text, View } from 'react-native'
...
const ShopkeeperHome = ({route,navigation}) => {
    ...
    return (
        ...
        <ScrollView>
            ...
            <Card>
                <Button
                    buttonStyle={{borderRadius: 0, marginLeft: 0, marginRight: 0, marginBottom: 0,backgroundColor: '#A3E4D7'}}
                    title='Add Items' 
