...
import { View, TextInput, Image,StyleSheet, KeyboardAvoidingView, StatusBar } from 'react-native'
...
export default function Uploaddetail({route,navigation}) {
    ...
    const addItem = (url) => {
        ...
        firebase.firestore().collection('admin').doc(user).collection('items').doc(itemName).set({
            name: itemName,
            price: itemPrice,
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <KeyboardAvoidingView  behavior="padding" style={styles.container}>
                ...
                /> 
                <Button
             buttonStyle={{borderRadius: 30,width:240, marginLeft: 40,marginTop: 30, marginRight: 40, marginBottom: 18,backgroundColor: 'black'}}
